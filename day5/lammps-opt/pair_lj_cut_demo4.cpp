...
PairLJCutDemo4::PairLJCutDemo4(LAMMPS *lmp) : PairLJCut(lmp)
{
  respa_enable = 0;
  single_enable = 0;
}
...
void PairLJCutDemo4::compute(int eflag, int vflag)
{
  ev_init(eflag,vflag);
